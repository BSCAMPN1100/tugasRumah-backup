...
@section('title', 'Tambah Barang · CatatRezekimu')
    ...
    <div class="card-main">
        ...
        <form action="{{ route('barang.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="satuan" name="satuan" value="{{ old('satuan') }}" placeholder="Contoh: kg, liter, pcs">
                @error('satuan') <div class="error">{{ $message }}</div> @enderror
            </div>

            <div class="form-group">
                <label for="harga_modal">Harga Modal (Rp)</label>
                <input type="number" id="harga_modal" name="harga_modal" value="{{ old('harga_modal', 0) }}" step="0.01" min="0">
            ...
            <div class="form-group">
                ...
                <input type="number" id="harga_jual" name="harga_jual" value="{{ old('harga_jual') }}" step="0.01" min="0" required>
