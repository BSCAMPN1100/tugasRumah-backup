...
@section('title', 'Dashboard Sales · CatatRezekimu')
...
<div class="dashboard-wrapper">
    <div class="dashboard-card">
        ...
        <div class="dash-header">
            <div class="greeting">
                <h2>👋 Halo, {{ auth()->user()->display_name ?? auth()->user()->name }}</h2>
                <p>Selamat bertugas, jangan lupa catat penjualan!</p>
            </div>
        ...
        <div class="summary-grid">
            <div class="summary-card">
                ...
                <div class="value">{{ $totalTransaksiHariIni }}</div>
            </div>
            <div class="summary-card">
        ...
        <!-- Menu utama -->
        <div class="menu-grid">
            <a href="{{ route('penjualan.create') }}" class="menu-item">
                <span class="icon">🛒</span>
                <div class="label">Catat Penjualan</div>
                <div class="sub-label">Tambah transaksi baru</div>
            </a>

            <a href="{{ route('penjualan.index') }}" class="menu-item">
                <span class="icon">📋</span>
                <div class="label">Riwayat Penjualan Saya</div>
                <div class="sub-label">Lihat transaksi yang sudah dicatat</div>
            </a>
        </div>
