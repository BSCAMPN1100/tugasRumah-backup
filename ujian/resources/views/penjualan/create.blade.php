...
@section('title', 'Catat Penjualan · CatatRezekimu')
        ...
        <div class="bg-white rounded-3xl shadow-lg p-5">
            ...
            <div class="flex justify-between items-center mb-4">
                <div>
                    ...
                    <h1 class="text-2xl font-bold text-[#0b3b2c] mt-1">💰 Catat Penjualan</h1>
                </div>
            ...
            <div class="bg-[#f1f5f9] rounded-2xl p-4 mb-5">
                ...
                <div class="border-t border-gray-300 pt-3">
                    <div class="mb-3">
                        ...
                        <input type="number" id="uang-dibayar" value="0" min="0" 
            ...
            <button id="btn-simpan" class="btn-primary text-lg py-4" onclick="simpanPenjualan()">
                💾 Simpan Penjualan
            </button>
            <p class="text-xs text-center text-gray-400 mt-3">* Stok akan otomatis berkurang</p>
